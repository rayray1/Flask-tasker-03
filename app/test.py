...
class AllTests(unittest.TestCase):
    ...
    def test_users_can_login(self):
        self.register('Raymond', 'rayray@gmail.com', 'python', 'python')
        response = self.login('Raymond', 'python')
    ...
    def test_user_registeration(self):
        ...
        response = self.register(
            'Raymond', 'rayray@gmail.com', 'python', 'python'
        )
    ...
    def test_logged_in_users_can_logout(self):
        self.register(
            'John', 'joe@gmail.com', 'python101', 'python101'
        )
    ...
    def test_users_can_add_tasks(self):
        self.create_user('Raymond', 'rayray@gmail.com', 'python')
        self.login('Raymond', 'python')
    ...
    def test_users_cannot_complete_tasks_that_are_not_created_by_them(self):
        ...
        self.create_task()
        self.logout()
        self.create_user('Ray', 'rayee@gmail.com', 'python101')
        self.login('Raymond', 'python101')
        self.app.get('tasks/', follow_redirects=True)
        response = self.app.get("complete/1/", follow_redirects=True)
        self.assertNotIn(
